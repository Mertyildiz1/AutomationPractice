...
public class C24_DownloadInvoiceAfterPurchaseOrder extends TestBase {
    ...
    public void test24() throws AWTException, InterruptedException {
        ...
        WebElement stylishDress = driver.findElement(By.xpath("//*[text()='Stylish Dress']"));
        actions.scrollToElement(stylishDress).perform();
        ...
        WebElement proceedCheckoutButton = driver.findElement(By.xpath("//a[@class='btn btn-default check_out']"));
        proceedCheckoutButton.click();

        // Click 'Register / Login' button
        WebElement registerLoginButton = driver.findElement(By.xpath("//*[text()='Register / Login']"));
        ...
        proceedCheckoutButton = driver.findElement(By.xpath("//a[@class='btn btn-default check_out']"));
        proceedCheckoutButton.click();
        ...
        WebElement orderPlaceContinueButton = driver.findElement(By.xpath("//a[@class='btn btn-primary']"));
        orderPlaceContinueButton.click();
